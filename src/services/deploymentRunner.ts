    ...
    const stepsConfig = [
      {
        ...
        logs: [
          { service: 'GitHub App', level: 'INFO' as const, msg: 'Connecting to GitHub Organization acme-corp...' },
          { service: 'GitHub App', level: 'INFO' as const, msg: 'Repository acme-corp/cloud-app created successfully.' },
      ...
      },
      {
        ...
        logs: [
          ...
          { service: 'OpenTofu Runner', level: 'INFO' as const, msg: 'OpenTofu v1.6.2 successfully initialized in workspace.' },
      ...
      },
      {
        ...
        logs: [
          { service: 'Cloudflare Provider', level: 'INFO' as const, msg: 'Creating Cloudflare Pages project app-frontend...' },
          { service: 'Cloudflare Provider', level: 'INFO' as const, msg: 'Allocating Cloudflare D1 Relational DB app_db_prod...' },
          { service: 'Cloudflare Provider', level: 'INFO' as const, msg: 'Creating Cloudflare R2 bucket app-storage-bucket...' },
      ...
      },
      {
        ...
        logs: [
          { service: 'Secret Manager', level: 'INFO' as const, msg: 'Encrypting 4 secrets for Production environment...' },
          { service: 'Secret Manager', level: 'INFO' as const, msg: 'Synced binding DATABASE_URL -> d1://app_db_prod' },
        ],
        delay: 1500,
      },
      {
        stepIdx: 5,
        currentStepMsg: 'Building Next.js Application Bundle...',
        logs: [
          { service: 'Build Engine', level: 'INFO' as const, msg: 'Executing: npx next build --target cloudflare-pages' },
          { service: 'Build Engine', level: 'INFO' as const, msg: 'Compiled 18 static routes & 4 edge functions (842ms).' },
          { service: 'Cloudflare CDN', level: 'INFO' as const, msg: 'Deployed artifacts across 320 global edge locations.' },
        ],
        delay: 2800,
      },
      {
        ...
        logs: [
          { service: 'Health Check', level: 'INFO' as const, msg: 'Ping GET https://nexus-storefront.pages.dev/api/health -> 200 OK (14ms)' },
